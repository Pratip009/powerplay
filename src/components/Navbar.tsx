        ...
        >
          ...
          >
            <div
              style={{
                position: "relative",
                width: "clamp(120px, 12vw, 200px)", // min 120px → scales → max 200px
                height: "clamp(36px, 4vw, 60px)", // proportional height
                flexShrink: 0,
            ...
            >
              <Image
                ...
                style={{
                  objectFit: "contain",
                  objectPosition: "left center", // anchors logo to the left
                }}
              />
            </div>
          </Link>
  ...
  return (
    <a
      ...
      style={{
        ...
        textDecoration: "none",
        color: hovered ? "#040a12" : "#BBCE1E",
        background: hovered
          ? "linear-gradient(135deg, #cadf14, #a1af27)"
          : "transparent",
        border: "1px solid rgba(187,206,30,0.5)",
        padding: "0.55rem clamp(0.9rem,2vw,1.3rem)",
        borderRadius: "7px",
        display: "flex",
        alignItems: "center",
        gap: "6px",
        boxShadow: hovered ? "0 0 28px rgba(187,206,30,0.4)" : "none",
      ...
      {[0, 1, 2].map((i) => (
        <span
          ...
          style={{
            display: "block",
            width:
              i === 1 ? (open ? "0px" : hovered ? "14px" : "18px") : "18px",
            height: "1.5px",
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "repeating-linear-gradient(90deg, transparent, transparent 60px, rgba(34,197,94,0.018) 60px, rgba(34,197,94,0.018) 61px)",
            }}
          />
        </div>
            ...
            >
                ...
                style={{
                  ...
                  transform:
                    hoveredIdx === i
                      ...
                      : "scale(1) rotate(0deg)",
                  boxShadow:
                    hoveredIdx === i ? "0 0 16px rgba(34,197,94,0.2)" : "none",
                }}
              >
                {link.icon}
              </div>
              ...
              <span
                style={{
                  ...
                  lineHeight: 1,
                  color:
                    hoveredIdx === i ? "#ffffff" : "rgba(220,235,245,0.75)",
                  transition: "color 0.25s ease, text-shadow 0.25s ease",
                  textShadow:
                    hoveredIdx === i ? "0 0 40px rgba(34,197,94,0.3)" : "none",
                  flex: 1,
                }}
              >
        ...
        <div
          style={{
            padding:
              "clamp(1rem,3vh,1.5rem) clamp(1.5rem,4vw,2.5rem) clamp(1.5rem,4vh,2.5rem)",
        ...
        >
          ...
          <a
            ...
            style={{
              ...
              borderRadius: "10px",
              background: "linear-gradient(135deg, #BBCE1E, #16a34a)",
              color: "#040a12",
              fontFamily: "'Barlow Condensed', sans-serif",
              fontWeight: 900,
              ...
              textDecoration: "none",
              boxShadow:
                "0 0 35px rgba(34,197,94,0.35), inset 0 1px 0 rgba(255,255,255,0.15)",
