...
const contactInfo = [
  {
    ...
    label: "Location",
    value:
      "310/311, East Ghoshpara Road, Pinkal, Shyamnagar, Kolkata, North 24 PGS.-743127",
    accent: "#22c55e",
    emoji: "📍",
  },
  {
  ...
  return (
    <input
      ...
      style={{
        ...
        boxShadow: focused
          ? "0 0 0 3px rgba(34,197,94,0.08), 0 0 20px rgba(34,197,94,0.1)"
          : "none",
        background: focused
          ? "rgba(34,197,94,0.04)"
      ...
      >
        ...
        <div
          style={{
            ...
            height: "400px",
            background:
              "radial-gradient(ellipse at top, rgba(34,197,94,0.09) 0%, transparent 70%)",
          }}
        />
        {/* Left blob */}
        <div
        ...
        <div className="contact-grid">
          ...
          <div
            ...
            style={{
              ...
              transition:
                "opacity 0.9s ease, transform 0.9s cubic-bezier(0.23,1,0.32,1)",
            }}
          >
            {/* Label */}
            <p
          ...
          <div
            ...
            style={{
              ...
              transition:
                "opacity 0.9s ease 0.1s, transform 0.9s cubic-bezier(0.23,1,0.32,1) 0.1s",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "2px",
                  background:
                    "linear-gradient(90deg, transparent, #22c55e, #22c55e80, transparent)",
                ...
                >
                  <div
                    style={{
                      fontSize: "3.5rem",
                      marginBottom: "1rem",
                      animation: "jumpA 0.6s ease forwards",
                    }}
                  >
                    ✅
                  </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? `0 12px 40px rgba(0,0,0,0.4), 0 0 25px ${item.accent}12`
          : "none",
