      ...
      >
        ...
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent, rgba(34,197,94,0.5), rgba(34,197,94,0.8), rgba(34,197,94,0.5), transparent)",
            boxShadow:
      ...
      >
        ...
        <div className="footer-grid">
          ...
          <div
            ...
            style={{
              ...
              transition:
                "opacity 0.8s ease 0.05s, transform 0.8s cubic-bezier(0.23,1,0.32,1) 0.05s",
            }}
          >
            {/* Logo */}
            <div
        ...
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent, rgba(34,197,94,0.15), rgba(34,197,94,0.08), transparent)",
            opacity: visible ? 1 : 0,
