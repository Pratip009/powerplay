...
export default function Sports() {
  ...
  const floatingIcons = [
    { emoji: "⚽", top: "8%", left: "4%", size: "2.8rem", anim: "jumpA", delay: "0s", blur: 0 },
    { emoji: "🏏", top: "12%", right: "6%", size: "2.4rem", anim: "jumpB", delay: "0.6s", blur: 0 },
    { emoji: "🔥", top: "35%", left: "2%", size: "1.9rem", anim: "jumpC", delay: "1.1s", blur: 1 },
    { emoji: "🏆", top: "55%", right: "3%", size: "2.2rem", anim: "jumpA", delay: "0.3s", blur: 0 },
    { emoji: "⚡", top: "72%", left: "6%", size: "2rem", anim: "jumpB", delay: "1.8s", blur: 1 },
    { emoji: "🌿", top: "80%", right: "7%", size: "2.1rem", anim: "jumpC", delay: "0.9s", blur: 0 },
    { emoji: "⚽", top: "90%", left: "40%", size: "1.6rem", anim: "jumpA", delay: "2.2s", blur: 2 },
    { emoji: "🌙", top: "22%", left: "50%", size: "1.7rem", anim: "jumpB", delay: "1.5s", blur: 2 },
    { emoji: "💫", top: "62%", left: "25%", size: "1.5rem", anim: "jumpC", delay: "0.4s", blur: 2 },
    { emoji: "🏏", top: "46%", right: "12%", size: "1.8rem", anim: "jumpA", delay: "1.2s", blur: 1 },
  ];
